...
const _EditProfileScreen: React.FC<EditProfileScreenProps> = ({
  userReducer,
  onUserEditProfile,
  onUserChangePassword,
  route,
...
const EditProfileScreen = connect(mapToStateProps, {
  onUserEditProfile,
  onUserChangePassword,
})(_EditProfileScreen);
