...
import {UserState, onForgotPassword, ApplicationState, Response } from '../redux';
...
const _ForgotPasswordScreen: React.FC<ForgotPasswordScreenProps> = ({onForgotPassword}) => {
    ...
    const resetPassword = async (token: string, password: string) => {
        try {
            await axios.post<Response>(`${BASE_URL}users/reset`, {
                token,
                password
            }).then(response => {
    ...
    <View style={styles.container} >
...

        {
            ...
            <View style={styles.input_container}>
                ...
                txtColor={MAIN_COLOR}
                />
                <TouchableOpacity onPress={() => setIsForgotSent(false)} style={{marginTop: 5}}>
...
const ForgotPasswordScreen = connect(mapStateToProps, {onForgotPassword})(_ForgotPasswordScreen);
